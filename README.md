...
For this demonstration, I am sending the data to [Webhook.site](https://webhook.site/#!/).

![WebHook Site](.github/images/goldilocks-webhook-site.png)


I sent the data to [Webhook.site](https://webhook.site/#!/) strictly for Proof of Concept (POC) purposes. However, we can now configure our CI/CD pipelines to receive these JSON payloads, compare the resource values, and send alerts or notifications to a Slack channel, for example.

The sky is the limit!

## Acknowledgments & Let's Connect

Thank you for taking the time to read this guide! I hope this helps you optimize your Kubernetes clusters, improve your infrastructure performance, and save on cloud costs. A special thanks to the open-source community and Fairwinds for creating such a valuable tool like Goldilocks.

**[Visit my Website](https://paulofabiano.com.br/)**

I am always open to talking about tech, sharing knowledge, and learning new things. Let's connect:
